...
const pagePath = {
    acos: '#/introduction/acos?eventid=catalyst_test&testmap=webglmap',
}
exports.test = function (driver, t) {
    ...
    t.describe('ACOSforVA', function () {
        ...
        const tooltip_point = { x: 647, y: 512 };
        ...
        t.it('ACOSforVA_map_slide', function (done) {
            driver.actions().mouseMove(driver.findElement(By.id('map')), { x: 650, y: 400 }).mouseDown().mouseMove({ x: 500, y: -200 }).perform() // @test mapを移動
