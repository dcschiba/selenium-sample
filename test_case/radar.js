...
const pagePath = {
    radar: '#/introduction/radar?eventid=catalyst_test&testmap=webglmap',
}
exports.test = function (driver, t) {
    ...
    const move_area = { // @func("move_area")
        ...
        US_AK: () => {
            driver.findElement(By.id('webglzoomoutbt')).click() // @test ズームアウト
                ...
                .then(() => driver.findElement(By.id('webglzoomoutbt')).click()) // @test ズームアウト
                .then(() => driver.actions().mouseMove(driver.findElement(By.id('map')), { x: 700, y: 100 }).mouseDown().mouseMove({ x: -400, y: 250 }).perform()) // @test アラスカへ移動 
        ...
        US_HI: () => {
            driver.findElement(By.id('webglzoomoutbt')).click() // @test ズームアウト
                .then(() => driver.findElement(By.id('webglzoomoutbt')).click()) // @test ズームアウト
                .then(() => driver.findElement(By.id('webglzoomoutbt')).click()) // @test ズームアウト
                .then(() => driver.actions().mouseMove(driver.findElement(By.id('map')), { x: 700, y: 300 }).mouseDown().mouseMove({ x: -450, y: -150 }).perform()) // @test ハワイへ移動
                .then(() => driver.actions().mouseUp().perform())
                .then(() => driver.findElement(By.id('webglzoominbt')).click()) // @test ズームイン
                .then(() => driver.findElement(By.id('webglzoominbt')).click()) // @test ズームイン
                .then(() => driver.actions().mouseMove(driver.findElement(By.id('map')), { x: 400, y: 100 }).mouseDown().mouseMove({ x: 300, y: 200 }).perform()) // @test ハワイへ移動
                .then(() => driver.actions().mouseUp().perform());
        },
        US_NA: () => {
            driver.findElement(By.id('webglzoomoutbt')).click() // @test ズームアウト
                .then(() => driver.findElement(By.id('webglzoomoutbt')).click()) // @test ズームアウト
                .then(() => driver.findElement(By.id('webglzoomoutbt')).click()) // @test ズームアウト
                .then(() => driver.actions().mouseMove(driver.findElement(By.id('map')), { x: 1000, y: 100 }).mouseDown().mouseMove({ x: -700, y: 0 }).perform()) // @test 北アメリカへ移動
                .then(() => driver.actions().mouseUp().perform())
                .then(() => driver.findElement(By.id('webglzoominbt')).click()); // @test ズームイン
        },
        US_PR: () => {
            driver.findElement(By.id('webglzoomoutbt')).click() // @test ズームアウト
                .then(() => driver.findElement(By.id('webglzoomoutbt')).click()) // @test ズームアウト
                .then(() => driver.findElement(By.id('webglzoomoutbt')).click()) // @test ズームアウト
                .then(() => driver.actions().mouseMove(driver.findElement(By.id('map')), { x: 1200, y: 400 }).mouseDown().mouseMove({ x: -900, y: -120 }).perform()) // @test プエルトリコへ移動
                .then(() => driver.actions().mouseUp().perform())
                .then(() => driver.findElement(By.id('webglzoominbt')).click()) // @test ズームイン
                .then(() => driver.findElement(By.id('webglzoominbt')).click()); // @test ズームイン
        },
        EU: () => {
            driver.findElement(By.id('webglzoomoutbt')).click() // @test ズームアウト
                .then(() => driver.findElement(By.id('webglzoomoutbt')).click()) // @test ズームアウト
                .then(() => driver.findElement(By.id('webglzoomoutbt')).click()) // @test ズームアウト
                .then(() => driver.actions().mouseMove(driver.findElement(By.id('map')), { x: 400, y: 100 }).mouseDown().mouseMove({ x: 800, y: 120 }).perform()) // @test ヨーロッパへ移動
                .then(() => driver.actions().mouseUp().perform())
                .then(() => driver.findElement(By.id('webglzoominbt')).click()) // @test ズームイン
                .then(() => driver.findElement(By.id('webglzoominbt')).click()) // @test ズームイン
        },
        ...
        KR: () => {
            driver.actions().mouseMove(driver.findElement(By.id('map')), { x: 500, y: 100 }).mouseDown().mouseMove({ x: 500, y: 0 }).perform() // @test 韓国へ移動
                .then(() => driver.actions().mouseUp().perform())
        },
        TW: () => {
            driver.findElement(By.id('webglzoomoutbt')).click() // @test ズームアウト
                .then(() => driver.actions().mouseMove(driver.findElement(By.id('map')), { x: 500, y: 500 }).mouseDown().mouseMove({ x: 400, y: -300 }).perform()) // @test 台湾へ移動
                .then(() => driver.actions().mouseUp().perform())
                .then(() => driver.findElement(By.id('webglzoominbt')).click()) // @test ズームイン
        }, // @func_end
    };
    ...
    function check_func(func_num, func_name, area, time, screenshotDir, masterScreenshotDir) {
        ...
        t.it('Radar_' + func_name + '_validtime_change', function (done) {
            driver.findElement(By.xpath(`//div[@id="root"]/div/div[2]/div/div/div[1]/div/div/div/div/div/div/div[${func_num + 1}]/div[2]/select/option[${time}]`)).click() // @test 過去時刻を変更
                .then(() => common.checkstatus())
                .then(() => driver.sleep(1000))
                .then(() => common.saveScreenshot(screenshotDir, masterScreenshotDir, this.test.title)) // @test 画像比較
                .then((result) => {
    ...
    t.describe('Radar', function () {
        ...
        t.it('Radar_JP_ICDB_validtime_change', function (done) {
            driver.findElement(By.xpath(`//div[@id="root"]/div/div[2]/div/div/div[1]/div/div/div/div/div/div/div[13]/select/option[${sample_time.JP_ICDB}]`)).click() // @test 過去時刻を変更
                .then(() => common.checkstatus())
                .then(() => driver.sleep(2000))
                .then(() => common.saveScreenshot(screenshotDir, masterScreenshotDir, this.test.title)) // @test 画像比較
                .then((result) => {
